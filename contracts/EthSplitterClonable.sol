...
/// @notice contract that is cloned with EthSplitterFactoryV2
contract EthSplitterClonable is Owned, ReentrancyGuard, Initializable {
    ...
    /// @dev for clonable contracts a separate initialize function is required instead of a constructor
    /// @dev only callable once
    /// @param _owner owner of the splitter contract
